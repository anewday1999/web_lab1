...
class subs_employee(models.Model):
...
class employeepost(models.Model):
    ...
    report = models.ManyToManyField(User, default=None, blank=True, related_name='employee_report_set')
    post_img1 = models.ImageField(_("Ảnh 1:"), upload_to='postImg/employee/', null=True, blank=True)
    post_img2 = models.ImageField(_("Ảnh 2:"), upload_to='postImg/employee/', null=True, blank=True)
