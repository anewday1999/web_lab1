    ...
    .done(function(response){
        if (response['success'] == false){
            ...
            if (response['detail'] == 'like')
            {
                ...
                e.target.textContent = "Bỏ báo cáo"
                e.target.style = "background-color:#009900;"
            }
            else if (response['detail'] == 'unlike')
            {
                let num_reports_display_id = "#num_reports_display" + post_id
                $(num_reports_display_id).html(response['num'] + " reports")
                e.target.textContent = "Báo cáo tin giả"
                e.target.style = "background-color:#991f00;"
    ...
    .done(function(response){
        if (response['success'] == 'False'){
            ...
            if (date != null){
                ...
                $("#last_login").html("Lần đăng nhập cuối: " + date )
            }
