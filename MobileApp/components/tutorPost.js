...
export default class tutorPost extends Component {
  constructor(props){
    super(props)
    this.state={
      title: '',
  ...
  Submit(){
    ...
    axios({
        method: 'POST',
        url: 'http://127.0.0.1/api/v1/tutorPost/',
        data: article,
        headers:{
  ...
  render(){
    ...
    return (
      <View className={styles.container}>
        <Text style={{fontSize:40, fontWeight:'bold', color : '#000000', marginTop: 70, textAlign:'center'}}>Post in tutor!</Text>
        ...
        <View style = {{flexDirection:'row', marginTop: 15, marginLeft: 20}}>
          <Inputplace text='Subject:              ' secure={false} state='subject' that={this}/>
        </View>
